...
class InventoryEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory_entry" do
    assert_difference('InventoryEntry.count') do
      post inventory_entries_url, params: { inventory_entry: { entry_date: @inventory_entry.entry_date, inventory_id: @inventory_entry.inventory_id, number_of_units: @inventory_entry.number_of_units } }
    end
  ...
  test "should update inventory_entry" do
    patch inventory_entry_url(@inventory_entry), params: { inventory_entry: { entry_date: @inventory_entry.entry_date, inventory_id: @inventory_entry.inventory_id, number_of_units: @inventory_entry.number_of_units } }
