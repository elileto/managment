...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { material_id: @cost.material_id, price_per_unit: @cost.price_per_unit, unit: @cost.unit } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { material_id: @cost.material_id, price_per_unit: @cost.price_per_unit, unit: @cost.unit } }
