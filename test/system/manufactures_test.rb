...
class ManufacturesTest < ApplicationSystemTestCase
  ...
  test "creating a Manufacture" do
    ...
    fill_in "Business Name", with: @manufacture.business_name
    fill_in "Contact", with: @manufacture.contact
    fill_in "Email", with: @manufacture.email
    fill_in "Phone Number", with: @manufacture.phone_number
    fill_in "Website", with: @manufacture.website
